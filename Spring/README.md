...
| 61 | [Centralized configuration with Config Server](12-microservices-with-spring-cloud/61-centralized-configuration-with-config-server/61-centralized-configuration-with-config-server.md) |
| 62 | [Inter-service calls with Feign](12-microservices-with-spring-cloud/62-inter-service-calls-with-feign/62-inter-service-calls-with-feign.md) |
| 63 | [API gateway](12-microservices-with-spring-cloud/63-api-gateway/63-api-gateway.md) |
| 64 | [Resilience with circuit breakers (Resilience4j)](12-microservices-with-spring-cloud/64-resilience-with-circuit-breakers/64-resilience-with-circuit-breakers.md) |
...
| 66 | [Profiles for real environments](13-production-readiness/66-profiles-for-real-environments/66-profiles-for-real-environments.md) |
| 67 | [Packaging and running the fat jar](13-production-readiness/67-packaging-and-running-the-fat-jar/67-packaging-and-running-the-fat-jar.md) |
| 68 | [Dockerizing a Spring Boot application](13-production-readiness/68-dockerizing-a-spring-boot-application/68-dockerizing-a-spring-boot-application.md) |
| 69 | [Graceful shutdown and health checks](13-production-readiness/69-graceful-shutdown-and-health-checks/69-graceful-shutdown-and-health-checks.md) |
